...
# Начальные параметры окна Pygame
CAR_SIZE = 20
WINDOW_WIDTH = 800
WINDOW_HEIGHT = 600
...
class Car:
    ...
    def is_live(self, trace):
        ...
        if trace.get_at(self.radars[5][0]) == bg or trace.get_at(self.radars[6][0]) == bg or trace.get_at(self.radars[7][0]) == bg:
            self.is_alive = False
